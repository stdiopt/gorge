...
import (
	...
	"github.com/stdiopt/gorge/gorgeapp/mobile/internal/callfn"
	"github.com/stdiopt/gorge/gorgeapp/mobile/internal/mobileinit"
...
var handleUserFn func(App, interface{}) bool
...
func mainUI(vm, jniEnv, ctx uintptr) error {
	...
	for {
		...
		case e := <-theApp.Events():
			if !handleUserFn(theApp, e) {
				return
			}
		}
	}
