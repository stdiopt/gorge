...
import (
	_ "github.com/stdiopt/gorge/gorgeapp/mobile/internal/mobileinit"
...
func Handle(fn func(App, interface{}) bool) {
	handle(fn)
}
...
type App interface {
	...
	SetEventHandler(func(v interface{}))
}
...
func init() {
	...
	theApp.glctx = &gl.Wrapper{} //, theApp.worker = gl.NewContext()
}
...
type app struct {
	...
	processEvent func(v interface{})

	glctx gl.Context3
}

func (a *app) SetEventHandler(fn func(v interface{})) {
	a.processEvent = fn
}
